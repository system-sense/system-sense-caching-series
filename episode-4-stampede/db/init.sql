-- System Sense, Episode 1 -- seed data. Unchanged in Episodes 2 and 3.
--
...
-- Episode 3 counts queries. pg_stat_statements is Postgres' own count, kept
-- alongside the app's so the two can be compared rather than trusted.
